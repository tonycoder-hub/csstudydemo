...
namespace ConsoleAppHomework09
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Order order1 = new Order(5, details1);
            Order order2 = new Order(6, details2);
            Order order3 = new Order(7, details3);
            Order order4 = new Order(8, details4);
            ...
            using (var db = new OrderDataContext())
            {
                ...
                var ord = db.orders
                    .OrderBy(o=>o.orderDetails.OrderAmount)
                    .FirstOrDefault();
                Console.WriteLine(ord);

                Console.WriteLine("Updating...");
                ord.orderDetails.OrderName = "New Order Name";
                ord.orderDetails.OrderUserName = "New UserName";
                db.SaveChanges();
